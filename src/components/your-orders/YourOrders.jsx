    ...
    return (
      <div>
        <RadioGroup
          ...
          defaultValue={view}
        >
          <RadioButton value="buyer">Comprando</RadioButton>
          <RadioButton value="seller">Vendendo</RadioButton>
        </RadioGroup>
          ...
          renderItem={item => (
            <List.Item
              actions={[
                <IconText
                  type="check-circle-o"
                  text={view === 'buyer' ? 'Recebido' : 'Aceitar'}
            ...
            >
              ...
              >
                <Step title="Disponível" />
                <Step title="Comprando" />
                <Step title="Entrega" />
                <Step title="Completo" />
              </Steps>

              <div>
                {fromWei(item.product.price, 'ether').toString()} ether
              </div>
            </List.Item>
          )}
        />
